...
X_val = np.array(data_val['sentence'])
...
# Calculate TF-IDF (data vectorized)
...
def evaluate_roc(probs, y_true, filename):
...
y_train2 = np.where(y_train >= 0.5, 1, 0)
nb_model.fit(X_train_tfidf, y_train2)

probs = nb_model.predict_proba(X_val_tfidf)
y_val2 = np.where(y_val>=0.5,1,0)
# Evaluate the classifier
evaluate_roc(probs, y_val2, 'alpha.png')
"""
...
evaluate_roc(probs, y_val, 'bert.png')
